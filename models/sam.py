...
class SAM(nn.Module):
    def __init__(self, inp_size=None, encoder_mode=None, loss=None):
        ...
        self.image_encoder = ImageEncoderViT_TS(
            ...
            use_fft=encoder_mode['use_fft'],
            scale_factor=encoder_mode['scale_factor'],
            csa_block_indice=encoder_mode['csa_block_indice'],     
            mrm_block_indice=encoder_mode['mrm_block_indice']     
        )

        # for original sam mask decoder
        ...
        # )
        self.mask_decoder = FeatureFusionDecoder(c3_dims=256)
    ...
    def forward(self):
        # Embed prompts for original sam mask decoder
        ...
        # )
        low_res_masks = self.mask_decoder(feat_3, feat_2, feat_1)
